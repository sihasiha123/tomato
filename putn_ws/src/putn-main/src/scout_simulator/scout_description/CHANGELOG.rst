...
* Make base_footprint a child of aft_mapped
* Contributors: Paul Bovbel
...
* Get rid of chassis_link, switch to base_footprint and aft_mapped
...
* Major refactor for indigo release:
  * aft_mapped is now located on the ground plane, while chassis_link
...
* Changed the base.urdf.xacro to use base_footprint as the parent frame. For some reason, the new Gazebo paints all parts the same color as aft_mapped when aft_mapped is the parent.
